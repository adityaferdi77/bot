...
//
const BotName = 'JENDRAL BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/afrdy77/'; // Nama Instagramlu cok
const whatsapplu = '0831-3374-0589'; // Nomor whatsapplu cok
const kapanbotaktif = 'TUNGGU OWNER YANG AKTIFKAN'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/HO1eTqZn7zoHoxQmHtTNgo'; // OFFICIAL GRUP LU 1
const grupch2 = 'GA ADA BEB'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@FERDY`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@FERDY`)
})
...
axios.get(`https://mhankbarbar.herokuapp.com/nulis?text=${teks}&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then((res) => {
...
axios.get(`https://mhankbarbar.herokuapp.com/api/yta?url=${teks}&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then((res) => {
...
axios.get(`https://mhankbarbar.herokuapp.com/api/ytv?url=${teks}&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then((res) => {
    let hasil = `Download sendiri melalui link dibawah ya, takut servernya down xixi..\n\nSize: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://mhankbarbar.herokuapp.com/api/wiki?q=${teks}&lang=id&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then((res) => {
